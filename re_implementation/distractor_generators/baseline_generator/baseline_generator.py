...
class BaselineGenerator:
    ...
    def __init__(self, corpus_processor, all_words_details):
        ...
        self.logger.info(f"Generator initialized. Organized vocabulary into {len(self.pos_to_words_data_organized)} POS categories.")
    ...
    def generate_distractors(self, target_word_surface, sentence_with_blank, num_distractors=5):
        ...
        if not target_details:
            self.logger.error(f"Target word key ('{target_lemma}', '{target_pos}') not found in the processed corpus data.")
            return []
