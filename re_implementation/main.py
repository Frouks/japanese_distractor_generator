...
if __name__ == "__main__":
    ...
    test_items = [
        ...
        },
        {
            "type": "Closed Context",
            "target": "猫",
            "sentence": f"その___は魚を咥えて、ニャーと鳴いた。"
            # Translation: That ___ was holding a fish and meowed "nyaa".
        },
        ...
        # --- Pair 2: 本 (book) ---
        {
            "type": "Open Context",
            "target": "本",
            "sentence": f"図書館で面白い{BLANK_PLACEHOLDER}を借りた。"
            # Translation: I borrowed an interesting ___ from the library.
        },
        {
            "type": "Closed Context",
            "target": "本",
            "sentence": f"彼はその___のページをめくり、活字を追い始めた。"
            # Translation: He turned the ___'s pages and began to follow the printed text.
        },
        ...
        },
        {
            "type": "Closed Context",
            "target": "走る",
            "sentence": f"彼は100メートルを11秒で{BLANK_PLACEHOLDER}ことができる。"
            # Translation: He can ___ 100 meters in 11 seconds.
        },
...

        {
            ...
            "target": "政府",
            "sentence": f"内閣総理大臣が率いる日本{BLANK_PLACEHOLDER}は、新しい法案を国会に提出した。"
            # Translation: The Japanese ___, led by the Prime Minister, submitted a new bill to the Diet.
        },
        {
            "type": "Testing Similarity (Antonyms)",
            "target": "寒い",
            "sentence": f"今日の朝は本当に{BLANK_PLACEHOLDER}ですね。"
            # Translation: It's really ___ this morning, isn't it? (This one is naturally constrained)
        },
        {
            "type": "Testing Co-occurrence/Thematic",
            "target": "コーヒー",
            "sentence": f"彼は朝食に___を一杯飲みます。"
            # Translation: He drinks a cup of ___ for breakfast. (The word 'cup' provides a good constraint)
        },
        ...
        # =================================================================================
        {
            ...
            "target": "日",
            "sentence": f"次の日曜は父の{BLANK_PLACEHOLDER}なので、お墓参りに行きます。"
            # Translation: Next Sunday is Father's ___, so we will visit the grave. (Constraint: 'Father's ___' + 'grave visit' implies '命日' - anniversary of death, making '日' a good target)
        },
        {
            "type": "Ambiguous Kanji",
            "target": "金",
            "sentence": f"彼は銀行強盗で多額の現{BLANK_PLACEHOLDER}を手に入れた。"
            # Translation: He obtained a large amount of cash ___ in the bank robbery.
        },
    ]
